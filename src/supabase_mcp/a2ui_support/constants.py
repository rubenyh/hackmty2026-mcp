...
FINANCIAL_VIEW_DATA_URI = f"{FINANCIAL_VIEW_RESOURCE_URI}/data"
PRESENT_FINANCIAL_VIEW_ACTION = "request_financial_view"
PRESENT_FINANCIAL_VIEW_COMPONENT_ID = "request_financial_view_button"
